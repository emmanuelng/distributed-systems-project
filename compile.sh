...
{
	cd $DIR/network/network/
	javac ./*/*/*.java
	jar cf Network.jar .

	cp Network.jar $DIR/server/
	mv Network.jar $DIR/client/
} #&> /dev/null

# Compile the common classes
echo "Compiling the server common classes..."
{
	cd $DIR/server/common/
	export CLASSPATH=$DIR/server/common/
...
echo "Compiling the car manager..."
{
	...
	jar cf CarManagerInterface.jar cars/*.class
...
echo "Compiling the hotel manager..."
{
	...
	jar cf HotelManagerInterface.jar hotels/*.class
...
echo "Compiling the flight manager..."
{
	...
	jar cf FlightManagerInterface.jar flights/*.class
...
echo "Compiling the customer manager..."
{
	...
	# jar cvf CustomerManagerInterface.jar customers/*.cexport CLASSPATH=$CLASSPATH:$DIR/network/network/Network.jar
...
echo "Compiling the middleware..."
{
	...
	jar cf MiddlewareInterface.jar middleware/*.class
